        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnouncedPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Image = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    OwnerId = table.Column<int>(type: "int", nullable: false),
                    BookAuthorAuthorId = table.Column<int>(type: "int", nullable: true),
                    BookAuthorBookId = table.Column<int>(type: "int", nullable: true),
                    BookGenreBookId = table.Column<int>(type: "int", nullable: true),
                    BookGenreGenreId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
